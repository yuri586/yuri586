...
Открыт к **фрилансу, субподряду и backend-позициям** — особенно там, где нужно разгрузить основную команду: починить бота, написать парсер, прикрутить API, настроить интеграцию или привести в порядок старый код.
...
* [Writer Book Sales Showcase](https://github.com/yuri586/writer-book-sales-showcase) — публичная showcase-витрина production-сайта писателя с описанием архитектуры продажи книги, оплаты через YooKassa, webhook flow, выдачи доступа, magic-link входа и защищённого browser reader.
